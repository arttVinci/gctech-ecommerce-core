...
Pesanan Anda dengan nomor **#{{ $sales_order->rtx_id }}** telah dikirim dan sedang dalam perjalanan ke alamat tujuan.

---

## 📦 Informasi Pengiriman

- **Nomor Resi:** {{ $sales_order->sales_shipping->receipt_number ?? 'Belum tersedia' }}
- **Kurir:** {{ $sales_order->sales_shipping->kurir }}
