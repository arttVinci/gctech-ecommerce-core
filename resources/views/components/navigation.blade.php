<header class="bg-white border-b border-neutral-400">
   <div class="mx-auto flex max-w-[1600px] items-center p-3 lg:px-23 bg-white border-b border-neutral-300">
      <a href="{{ url('/') }}" class="-m-1.5 p-1.5 flex">
        <img src="{{ asset('media/logo.png') }}" alt="" class="h-8 w-auto" />
        <h1 class="hidden ml-2 text-xl font-semibold tracking-wide text-gray-900 md:block">
            {{ config('app.name') }}
        </h1>
      </a>
  ...
  <nav aria-label="Global" class="mx-auto flex max-w-[1400px] space-x-10 items-center p-3 lg:px-8">
