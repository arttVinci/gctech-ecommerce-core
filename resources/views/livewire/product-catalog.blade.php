            ...
            <div class="grid grid-cols-1 gap-10 pr-6 border-r border-gray-200 md:col-span-3">
                <div>
                    ...
                    <div class="block space-y-4">
                        @foreach ($collections as $i => $item)
                            <div class="flex items-center justify-between">
                                <div class="flex">
                                    <input wire:model="select_collections" value="{{ $item->id }}" type="checkbox"
                    ...
                    <div class="grid grid-cols-2 mt-10">
                        <button wire:loading.attr="disabled" wire:click="applyFilter" type="button"
                            ...
                            Apply Filter
                            <div wire:loading class="animate-spin inline-block size-4 border-3 border-current border-t-transparent text-gray-400 rounded-full" role="status" aria-label="loading">
